...
class TextBox(object):
    def __init__(self,rect,buffer=[],default_text=None,parent=None,current_row=None,**kwargs):
    ...
    def execute(self):
        if self.command:
            self.command(self.parent,self.id,self.final, self.current_row, self.default_text)
